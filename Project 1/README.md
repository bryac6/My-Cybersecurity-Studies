...
![TODO: Update the path with the name of your diagram](Images/Azure_Diagram.png)
...
- _TODO: What does Filebeat watch for? Filebeat monitors log files to collect log events. Information is then forwarded to either Logstash or Elasticsearch to be indexed.
...
- _TODO: Add whitelisted IP addresses_MY Public IP
...
_Which URL do you navigate to in order to check that the ELK server is running? 104.42.77.249:5601
